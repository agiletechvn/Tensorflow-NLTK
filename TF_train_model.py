...
# load the data from the pickle then unpack array into variables
...
def train_neural_network(x):
    ...
    # cross entropy for reduce loss then using Adam ( or stochastic gradient descent ) for backpropagation
